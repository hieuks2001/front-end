  ...
  <body class="min-h-screen">
    ...
    >
      <div class="flex flex-col items-center justify-center">
        ...
        <h1 class="text-6xl font-bold text-white">BOT TRADE</h1>
          ...
          <div class="mt-6 w-full">
            ...
            <div class="relative flex items-center justify-center">
              <input
                ...
                class="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"
                v-bind:class="{ 'border-2 border-rose-500': errors.password }"
              />
          ...
          <div class="mt-6 w-full">
            ...
            <div class="relative flex items-center justify-center">
              <input
                ...
                class="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"
                v-bind:class="{
                  'border-2 border-rose-500': errors.confirmPassword,
                }"
              />
              <div class="absolute right-0 mt-2 mr-3 cursor-pointer">
                <svg
...
export default {
  ...
  methods: {
    validate() {
      ...
      } else if (this.register.confirmPassword.length < 8) {
        this.errors.confirmPassword = "Password must be 8 characters or more!";
      }
